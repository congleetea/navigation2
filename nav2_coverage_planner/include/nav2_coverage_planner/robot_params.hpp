...
public:
  ...
  {
    nav2_util::declare_parameter_if_not_declared(node, "robot_width", rclcpp::ParameterValue(2.1));
   ...
   */
  double getWidth() { return robot_.robot_width; }

  /**
   * @brief Get the robot's operational width
   * @return robot's operational width in m
   */
  double getOperationWidth() { return robot_.op_width; }
