...
#include "nav2_coverage_planner/robot_params.hpp"
#include "nav2_coverage_planner/types.hpp"
#include "nav2_coverage_planner/utils.hpp"
#include "nav2_msgs/msg/swath_mode.hpp"
...
public:
   ...
   */
  Swaths generateSwaths(const Field & field, const nav2_msgs::msg::SwathMode & settings);
