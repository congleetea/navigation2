...
#include "nav2_coverage_planner/headland_generator.hpp"
#include "nav2_coverage_planner/path_generator.hpp"
#include "nav2_coverage_planner/route_generator.hpp"
#include "nav2_coverage_planner/swath_generator.hpp"
#include "nav2_coverage_planner/visualizer.hpp"
#include "rclcpp/rclcpp.hpp"

namespace nav2_coverage_planner
{
/**
 * @class nav2_coverage_planner::CoverageServer
...
public:
  ...
  /**
   * @brief A constructor for nav2_coverage_planner::CoverageServer
   * @param options Additional options to control creation of the node.
   */
  explicit CoverageServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief A destructor for nav2_coverage_planner::CoverageServer
   */
