...
: public nav2_behavior_tree::BtActionNode<nav2_msgs::action::ComputeCoveragePath>
{
  using Action = nav2_msgs::action::ComputeCoveragePath;
  using ActionResult = Action::Result;

public:
  /**
   * @brief A constructor for nav2_behavior_tree::ComputeCoveragePathAction
