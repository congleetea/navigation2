 ...
 */
class CoverageNavigator : public nav2_core::Navigator<nav2_msgs::action::NavigateCompleteCoverage>
{
public:
  using ActionT = nav2_msgs::action::NavigateCompleteCoverage;

  /**
   * @brief A constructor for CoverageNavigator
   */
  CoverageNavigator() : Navigator() {}
