 ...
 * with the (0,0) origin to the non-existing in ROS frame, which origin is equal
 * to pose
...
/**
 * @brief Linearly projects pose towards to velocity direction on dt time
 * interval. Turns the velocity on twist angle for dt time interval.
 ...
 * @param velocity Velocity at which the pose to be moved. It is also being
 * rotated on according twist angle.
 */
