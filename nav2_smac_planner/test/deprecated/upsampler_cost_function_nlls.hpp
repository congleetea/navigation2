...
public:
   ...
   * nav2_smac_planner::UpsamplerConstrainedCostFunction
  ...
  UpsamplerConstrainedCostFunction(
    ...
    const int & upsample_ratio, const int & i)
  : _path(path), _params(params), _upsample_ratio(upsample_ratio), index(i)
  {
  }
...
protected:
    ...
    const Eigen::Vector2d & pt_m, CurvatureComputations & curvature_params, double & r) const
  {
    ...
    r += weight * curvature_params.ki_minus_kmax * curvature_params.ki_minus_kmax;
  }
