...
{
/**
 * @brief Base class for creating a plugin in order to perform a specific task
 * at waypoint arrivals.
 *
 */
...
public:
  ...
  /**
   * @brief Override this to setup your pub, sub or any ros services that you
   * will use in the plugin.
   *
   * @param parent parent node that plugin will be created within(for an example
   * see nav_waypoint_follower)
